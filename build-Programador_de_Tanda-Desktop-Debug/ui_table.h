...
public:
    ...
    void setupUi(QDialog *Table)
    {
        ...
        txtOriginPath->setObjectName(QString::fromUtf8("txtOriginPath"));

        horizontalLayout_6->addWidget(txtOriginPath);

        browseOriginFolderButton = new QPushButton(Table);
        browseOriginFolderButton->setObjectName(QString::fromUtf8("browseOriginFolderButton"));
        ...
        txtDestinyPath->setObjectName(QString::fromUtf8("txtDestinyPath"));

        horizontalLayout_5->addWidget(txtDestinyPath);

        browseDestinyFolderButton = new QPushButton(Table);
        browseDestinyFolderButton->setObjectName(QString::fromUtf8("browseDestinyFolderButton"));
