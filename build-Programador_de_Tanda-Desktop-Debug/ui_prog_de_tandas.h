...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        subir_boton->setObjectName(QString::fromUtf8("subir_boton"));
        ...
        Martes->setObjectName(QString::fromUtf8("Martes"));
        ...
        Miercoles->setObjectName(QString::fromUtf8("Miercoles"));
        ...
        Jueves->setObjectName(QString::fromUtf8("Jueves"));
        ...
        Viernes->setObjectName(QString::fromUtf8("Viernes"));
        ...
        Sabado->setObjectName(QString::fromUtf8("Sabado"));
        ...
        Domingo->setObjectName(QString::fromUtf8("Domingo"));
        ...
        primer_horario->setObjectName(QString::fromUtf8("primer_horario"));
        ...
        Lu_1->setObjectName(QString::fromUtf8("Lu_1"));
        ...
        Sa_1->setObjectName(QString::fromUtf8("Sa_1"));
        ...
        segundo_horario->setObjectName(QString::fromUtf8("segundo_horario"));
        ...
        Sa_2->setObjectName(QString::fromUtf8("Sa_2"));
        ...
        tercer_horario->setObjectName(QString::fromUtf8("tercer_horario"));
        ...
        Sa_3->setObjectName(QString::fromUtf8("Sa_3"));

        horizontalLayout_8->addWidget(Sa_3, 0, Qt::AlignHCenter);

        Do_3 = new QCheckBox(Widget);
        Do_3->setObjectName(QString::fromUtf8("Do_3"));
        ...
        cuarto_horario->setObjectName(QString::fromUtf8("cuarto_horario"));
        ...
        Lu_4->setObjectName(QString::fromUtf8("Lu_4"));
        ...
        Sa_4->setObjectName(QString::fromUtf8("Sa_4"));

        horizontalLayout_9->addWidget(Sa_4, 0, Qt::AlignHCenter);

        Do_4 = new QCheckBox(Widget);
        Do_4->setObjectName(QString::fromUtf8("Do_4"));
        ...
        quinto_horario->setObjectName(QString::fromUtf8("quinto_horario"));
        ...
        Sa_5->setObjectName(QString::fromUtf8("Sa_5"));

        horizontalLayout_11->addWidget(Sa_5, 0, Qt::AlignHCenter);

        Do_5 = new QCheckBox(Widget);
        Do_5->setObjectName(QString::fromUtf8("Do_5"));
        ...
        sexto_horario->setObjectName(QString::fromUtf8("sexto_horario"));
        ...
        Sa_6->setObjectName(QString::fromUtf8("Sa_6"));

        horizontalLayout_12->addWidget(Sa_6, 0, Qt::AlignHCenter);

        Do_6 = new QCheckBox(Widget);
        Do_6->setObjectName(QString::fromUtf8("Do_6"));
        ...
        septimo_horario->setObjectName(QString::fromUtf8("septimo_horario"));
        ...
        Sa_7->setObjectName(QString::fromUtf8("Sa_7"));

        horizontalLayout_13->addWidget(Sa_7, 0, Qt::AlignHCenter);

        Do_7 = new QCheckBox(Widget);
        Do_7->setObjectName(QString::fromUtf8("Do_7"));
        ...
        octavo_horario->setObjectName(QString::fromUtf8("octavo_horario"));
        ...
        Sa_8->setObjectName(QString::fromUtf8("Sa_8"));

        horizontalLayout_14->addWidget(Sa_8, 0, Qt::AlignHCenter);

        Do_8 = new QCheckBox(Widget);
        Do_8->setObjectName(QString::fromUtf8("Do_8"));
        ...
        noveno_horario = new QLabel(Widget);
        noveno_horario->setObjectName(QString::fromUtf8("noveno_horario"));
        noveno_horario->setFrameShape(QFrame::Box);
        noveno_horario->setFrameShadow(QFrame::Raised);
        noveno_horario->setAlignment(Qt::AlignCenter);

        horizontalLayout_15->addWidget(noveno_horario);

        Lu_9 = new QCheckBox(Widget);
        Lu_9->setObjectName(QString::fromUtf8("Lu_9"));

        horizontalLayout_15->addWidget(Lu_9, 0, Qt::AlignHCenter);

        Ma_9 = new QCheckBox(Widget);
        Ma_9->setObjectName(QString::fromUtf8("Ma_9"));

        horizontalLayout_15->addWidget(Ma_9, 0, Qt::AlignHCenter);

        Mi_9 = new QCheckBox(Widget);
        Mi_9->setObjectName(QString::fromUtf8("Mi_9"));

        horizontalLayout_15->addWidget(Mi_9, 0, Qt::AlignHCenter);

        Ju_9 = new QCheckBox(Widget);
        Ju_9->setObjectName(QString::fromUtf8("Ju_9"));

        horizontalLayout_15->addWidget(Ju_9, 0, Qt::AlignHCenter);

        Vi_9 = new QCheckBox(Widget);
        Vi_9->setObjectName(QString::fromUtf8("Vi_9"));

        horizontalLayout_15->addWidget(Vi_9, 0, Qt::AlignHCenter);

        Sa_9 = new QCheckBox(Widget);
        Sa_9->setObjectName(QString::fromUtf8("Sa_9"));

        horizontalLayout_15->addWidget(Sa_9, 0, Qt::AlignHCenter);

        Do_9 = new QCheckBox(Widget);
        Do_9->setObjectName(QString::fromUtf8("Do_9"));

        horizontalLayout_15->addWidget(Do_9, 0, Qt::AlignHCenter);
        ...
        bajar_boton->setObjectName(QString::fromUtf8("bajar_boton"));
        ...
        ver_tabla_button->setObjectName(QString::fromUtf8("ver_tabla_button"));
        ...
        generarButton->setObjectName(QString::fromUtf8("generarButton"));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        noveno_horario->setText(QCoreApplication::translate("Widget", "12:00", nullptr));
        Lu_9->setText(QString());
        Ma_9->setText(QString());
        Mi_9->setText(QString());
        Ju_9->setText(QString());
        Vi_9->setText(QString());
        Sa_9->setText(QString());
        Do_9->setText(QString());
