...
private:
    ...
    QString PathFile = "";
    int despla_v = 0;
    int primer_horario[28] = {0};
    int segundo_horario[28] = {0};
    int tercer_horario[28] = {0};
    int cuarto_horario[28] = {0};
    int quinto_horario[28] = {0};
    int sexto_horario[28] = {0};
    int septimo_horario[28] = {0};
    int octavo_horario[28] = {0};
    int noveno_horario[28] = {0};
